...
def Token(appkey):
    ...
    param = {"appkey": appkey}
    r_app_secret = requests.get("http://10.25.127.137:8788/appkey", headers=headers, params=param)
    ...
    rq_get_access_token = requests.post("http://10.25.127.137:8080/api/v1/token", headers=r_header, data=param)
    ...
    param = {"rid": rid, "access_token": access_token}
    rq_get_time = requests.post("http://10.25.127.137:8080/api/v1/attestation/get", data=param)
